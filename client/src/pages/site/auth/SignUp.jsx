    ...
    <>
      ...
      <div className="relative my-4 focus-within:border-blue-500">
        <input
          ...
          className="  block border-2 rounded w-full py-2 px-3 text-gray-700 leading-tight appearance-none focus:border-blue-500 focus:outline-none bg-transparent"
        />
        <label
          htmlFor="firstName"
      ...
      {/* SECTION LAST NAME */}
      <div className="relative my-4 mt-8 focus-within:border-2-blue-500">
        <input
          id="lastName"
          type="text"
          value={lastName}
          ...
          placeholder=" "
          onChange={(e) => handleChange(e)}
          className="  block border rounded w-full py-2 px-3 text-gray-700 leading-tight appearance-none focus:border-blue-500 focus:outline-none bg-transparent"
        />
        <label
          htmlFor="lastName"
          className="absolute top-0 -z-1 mt-2 ml-2 duration-500 text-gray-500"
              ...
              <div className="flex items-center justify-between">
                <Link to='/feed'
                  className={
                    ...
                    !password ||
                    !confirmPassword
                      ? "cursor-not-allowed opacity-50 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:border-blue-500"
                      : "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:border-blue-500"
                  }
